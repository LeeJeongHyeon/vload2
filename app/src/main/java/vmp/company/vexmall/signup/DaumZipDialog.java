...
public class DaumZipDialog extends Dialog {
    ...
    public DaumZipDialog(Context context, int id, TextView zipText, TextView address, int colorId) {
        super(context);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(id);
        header = findViewById(R.id.daum_zip_header);
        ...
        header.setBackground(context.getDrawable(colorId));
        // WebView 초기화
        init_webView();
